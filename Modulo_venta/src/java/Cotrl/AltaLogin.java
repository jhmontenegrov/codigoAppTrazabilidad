 ...
 * @author jhona
 */
@WebServlet(name = "AltaLogin", urlPatterns = {"/AltaLogin"})
...
//Extraigo el contexto del servlet
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            resultado = sentencia.executeQuery("SELECT * FROM usuario where user='" + usu + "' AND Contrasena = '" + clave + "' ");
...
//Validación de usuario y contraseña
                ...
                sc.getRequestDispatcher("/Inicio_sesion.jsp").forward(request, response);
            }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AltaLogin.class.getName()).log(Level.SEVERE, null, ex);
