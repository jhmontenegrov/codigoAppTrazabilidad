 ...
 * @author jhona
 */
public class ActualizarInfoUsuariosCtrol extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int idU = new Integer(request.getParameter("idU"));
            if (pass == null || pass.length()<=3) {
                ...
                actualizarInfoPerfilDAO.actualizarPass(usuario);
                request.getRequestDispatcher("/lista_usuario.jsp").forward(request, response);
            }
        } catch (SQLException ex) {
            Logger.getLogger(ActualizarInfoUsuariosCtrol.class.getName()).log(Level.SEVERE, null, ex);
